            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Student List</h3></a>
                    </div>
                    <div class="container-fluid">
                    
                        <div class="card shadow">
                            <div class="card-header d-sm-flex justify-content-between align">
                                <p class="text-primary m-0 font-weight-bold">ICT Students</p>
                                <div>
                                    <a class="btn btn-primary btn-sm d-none d-sm-inline-block <?php if($isAdmin != "admin"){ echo 'invisible';} ?>" role="button" href="/admin/student/register" >Add Student</a>
                                </div>
                                ...
                                <div class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                                    <table class="table" id="dataTable">
                                        <thead>
                                            ...
                                            <tr>
                                                <th style="padding-left: 10px;padding-right: 10px">Student ID</th>
                                                ...
                                                <th style="padding-left: 10px;padding-right: 10px">Sex</th>
                                        ...
                                        @foreach ($students as $student)
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-primary btn-sm" role="button" href="/profile/{{ $student->id }}">View</a></td>
                                                </a>
                                            </tr>
