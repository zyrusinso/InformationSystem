    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    ...
                    <a class="btn btn-outline-danger ml-3 btn-sm" href="/profile/{{ $student->id }}"> <i class="fas fa-arrow-left">Back</i> </a>
                    </div>
                </nav>
                ...
                <div class="row register-form ">
                    <div class="col-md-8 offset-md-2 ">
                        ...
                        <form action="/profile/{{ $student->id }}" method="post" class="custom-form shadow" style="margin-top: 29px;">
                            @csrf
                            @method('PATCH')
                            ...
                            <h1 style="height: 55px;">Edit Profile</h1>
                            <div class="form-row form-group" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-6 input-column"><input class="form-control " type="text" name="first_name" value="{{ old('first_name') ?? $student->first_name }}"></div>
                                
                            </div>
                            <div class="form-row form-group" style="margin-bottom: 5px;">
                                <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Last Name</label></div>
                                <div class="col-sm-6 input-column"><input class="form-control " type="text" name="last_name" value="{{ old('last_name') ?? $student->last_name }}"></div>
                            </div>
                            <div class="form-row form-group" style="margin-bottom: 5px;">
                                <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Middle Name</label></div>
                                <div class="col-sm-6 input-column"><input class="form-control" type="text" name="middle_name" value="{{ old('middle_name') ?? $student->middle_name }}"></div>
                            </div>

                            <div class="form-row form-group" style="margin-bottom: 5px;">
                                <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">LRN</label></div>
                                <div class="col-sm-6 input-column"><input class="form-control" type="number" name="lrn" value="{{ old('lrn') ?? $student->lrn }}"></div>
                            </div>
                            <div class="form-row form-group" style="margin-bottom: 5px;">
                                <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Student ID</label></div>
                                <div class="col-sm-6 input-column"><input class="form-control" type="text" name="stud_num" value="{{ old('student_num') ?? $student->stud_num }}"></div>
                            </div>
                            <div class="form-row form-group" style="margin-bottom: 5px;">
                                <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Age</label></div>
                                <div class="col-sm-6 input-column"><input class="form-control" type="number" style="width: 60px;" name="age" value="{{ old('age') ?? $student->age }}" min="0"></div>
                            </div>
                            <div class="form-row form-group" style="margin-bottom: 5px;">
                                <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Date of Birth</label></div>
                                <div class="col-sm-6 input-column"><input class="form-control" type="date" name="date_of_birth" value="{{ old('date_of_birth') ?? $student->date_of_birth }}"></div>
                            </div>
                            <div class="form-row form-group" style="margin-bottom: 5px;">
                                <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Section</label></div>
                                <div class="col-sm-6 input-column"><input class="form-control" type="number" style="width: 90px;" name="section" value="{{ old('section') ?? $student->section }}" min="1100"></div>
                            </div>
                            
                            
                        <button class="btn btn-light submit-button" type="submit" style="padding: 5px 22px;padding-right: 20px;padding-top: 9px;padding-bottom: 8px;">Submit</button>
                        @endforeach
                        </form>
                    </div>
